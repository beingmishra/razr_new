...
import com.razr.vpn.AppConfig.ANG_CONFIG
import com.razr.vpn.AppConfig.PROTOCOL_HTTPS
import com.razr.vpn.AppConfig.PROTOCOL_HTTP
import com.razr.vpn.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.razr.vpn.AppConfig.WIREGUARD_LOCAL_MTU
import com.razr.vpn.R
import com.razr.vpn.dto.*
import com.razr.vpn.dto.V2rayConfig.Companion.DEFAULT_SECURITY
import com.razr.vpn.dto.V2rayConfig.Companion.TLS
import com.razr.vpn.util.MmkvManager.KEY_SELECTED_SERVER
import java.net.URI
import java.util.*
import java.lang.reflect.Type
import com.razr.vpn.extension.idnHost
import com.razr.vpn.extension.removeWhiteSpace
    ...
    private fun tryResolveResolveSip002(str: String, config: ServerConfig): Boolean {
        try {
            ...
            if (query != "") {
                ...
                } else if (queryPairs["plugin"] == "razr-plugin") {
                    var network = "ws";
